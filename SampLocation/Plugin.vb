...
Imports SampLocation.SAMP_API.API


Namespace SampLocation
...
#End Region
        ...
        Public Shared Sub DLLMain()
            ...
            Dim IniAPI As Boolean = ExtractAPIFromResources()

            If IniAPI = False Then
                Exit Sub
            End If

            Dim CurrentProcess As Process = Process.GetCurrentProcess()
            Dim processName As String = CurrentProcess.ProcessName & ".exe"
